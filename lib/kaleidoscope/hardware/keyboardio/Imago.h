...
struct ImagoLEDDriverBlueprint: public kaleidoscope::driver::BaseLEDDriverBlueprint {
  static constexpr LEDCountType led_count = 78;
};

class ImagoLEDDriver : public kaleidoscope::driver::BaseLEDDriver<ImagoLEDDriverBlueprint> {
 public:
  static void setup();
...
struct ImagoDeviceBlueprint : kaleidoscope::hardware::avr::AVRDeviceBlueprint {
  typedef struct ImagoKeyScannerBlueprint : public kaleidoscope::driver::keyscanner::ATMegaKeyScannerBlueprint {
  ...
  typedef ImagoLEDDriverBlueprint LEDDriverBlueprint;
  typedef ImagoLEDDriver LEDDriver;
  typedef kaleidoscope::driver::bootloader::avr::Caterina BootLoader;
};

class Imago: public kaleidoscope::hardware::avr::AVRDevice<ImagoDeviceBlueprint> {};
